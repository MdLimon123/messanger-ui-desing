...
import 'package:messenger/helpers.dart';
...
import 'package:messenger/widgets/display_error_message.dart';
          ...
          child: Row(
            children: [
              Padding(
                ...
                child: Avatar.medium(url: messageData.profilePicture, onTab: () {  },),
              ),
              Expanded(
                  child: Column(
...
class _StoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Avatar.medium(url: storyData.url, onTab: () { },),
        Expanded(
            child: Padding(
